...
public class StringTest {
    ...
    /**
     * 任意给定英文字符串，求出各个字母出现的次数，并按照字母出现的次数从高到低排序。 思路： 1、先建立一个map,存储对应的字母以及次数
     * key-value, 2、自定义一个value的比较器Comparator,实现map按照key对应的value值排序。
     * 3、新建一个TreeMap,并传入比较器自定义排序规则，将之前map复制到treemap中。 4、遍历treemap即为所求。
     * 
     * @param args
     */
